...
// TEMP (CRON_SECRET-gated): read + resolve feedback headless. Remove after use.
app.http('cron-feedback', {
  ...
  handler: async (request, context) => {
    ...
    try {
      ...
      if (body.relocateTo === '') delete doc.relocateTo;
      else if (body.relocateTo) doc.relocateTo = String(body.relocateTo);
